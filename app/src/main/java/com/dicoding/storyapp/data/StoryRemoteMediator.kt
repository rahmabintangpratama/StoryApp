...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            Log.d("StoryRemoteMediator", "Loading page: $page")
            val response = apiService.getStories(page, state.config.pageSize).awaitResponse()
            val responseData = response.body()
            if (responseData == null || !response.isSuccessful) {
                Log.e("StoryRemoteMediator", "Failed to load data!")
            ...
            Log.d("StoryRemoteMediator", "Page $page loaded successfully.")
            return MediatorResult.Success(endOfPaginationReached = endOfPaginationReached)
        } catch (exception: Exception) {
            Log.e("StoryRemoteMediator", "Exception: ${exception.message}")
